...
extern interrupt_name_t OS21_INTERRUPT_MB_LX_AUDIO;

#define VIDEO_MBOX_IRQ	((unsigned int) &OS21_INTERRUPT_MB_LX_DPHI)	/* MBOX0 SET2 */
#define AUDIO_MBOX_IRQ	((unsigned int) &OS21_INTERRUPT_MB_LX_AUDIO)	/* MBOX1 SET2 */

#endif

#ifdef __KERNEL__

/* See ADCS 8063416 (Table 7) */
