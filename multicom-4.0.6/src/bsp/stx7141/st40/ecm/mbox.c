...
extern interrupt_name_t OS21_INTERRUPT_MBOX2_LX_DH_IRQ;
extern interrupt_name_t OS21_INTERRUPT_MBOX3_SH4_IRQ;

#define VIDEO_MBOX_IRQ	((unsigned int) &OS21_INTERRUPT_MBOX0_SH4_IRQ)	
#define ECM_MBOX_IRQ	((unsigned int) &OS21_INTERRUPT_MBOX2_LX_DH_IRQ)
#define AUDIO_MBOX_IRQ	((unsigned int) &OS21_INTERRUPT_MBOX1_SH4_IRQ)
#define ESTB_MBOX_IRQ	((unsigned int) &OS21_INTERRUPT_MBOX3_SH4_IRQ)
...
#define ECM_MBOX_IRQ	(65 + 12)			/* MBOX2 SET1 */
#define AUDIO_MBOX_IRQ	(65 + 11)			/* MBOX1 SET2 */
#define ESTB_MBOX_IRQ	(65 + 15)			/* MBOX3 SET2 */
...
struct bsp_mbox_regs bsp_mailboxes[] = 
{
  ...
  { 
    ...
    .interrupt	= ECM_MBOX_IRQ,				/* *WE* own SET1 */
    .flags      = 0
  },
  { 
  ...
  { 
    ...
    .interrupt  = 0,					/* ESTB owns SET1 */
    .flags      = 0
  },
  { 
    .base	= (void *) (MBOX3_ADDR+0x100),		/* ST40 ESTB Mailbox (MBOX3.2) */
    .interrupt  = ESTB_MBOX_IRQ,			/* *WE* own SET2 */
    .flags      = 0
  },
#endif /* DISABLE_ESTB_ECM_MAILBOXES */
};
