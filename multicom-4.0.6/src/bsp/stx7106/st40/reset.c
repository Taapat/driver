...
struct bsp_reg_mask bsp_sys_reset_bypass[] = {
  {STI7106_SYSCONF_SYS_CFG09, ~(1 << 28), 1 << 28}
};
...
struct bsp_boot_address_reg bsp_sys_boot_registers[] = {
  {0, 0, 0},						/* st40 */
  {STI7106_SYSCONF_SYS_CFG28, 0, 0xFFFFFF00},		/* video */
  {STI7106_SYSCONF_SYS_CFG26, 0, 0xFFFFFF00}		/* audio */
};

struct bsp_reg_mask bsp_sys_boot_enable[] = {
  {NULL, 0, 0},						/* st40 */
  {STI7106_SYSCONF_SYS_CFG28, ~1, 1},			/* video */
  {STI7106_SYSCONF_SYS_CFG26, ~1, 1}			/* audio */
};

struct bsp_reg_mask bsp_sys_reset_registers[] = {
  {NULL, 0, 0},						/* st40 */
  {STI7106_SYSCONF_SYS_CFG29, ~1, 1},			/* video */
  {STI7106_SYSCONF_SYS_CFG27, ~1, 1}			/* audio */
};
