...
struct platform_device tkdma_device_7109 = {
        .name = "tkdma",
        .id = -1,
        .num_resources = ARRAY_SIZE(tkdma_resource_7109),
        .resource = tkdma_resource_7109,
...
static struct platform_device *platform_7109_tkdma[] __initdata = {
  &tkdma_device_7109
};
...
#define SYSCONF_DEVICEID       (SYSCONF_BASE + 0x000)
    {
       ...
       if (tkdma)
	       platform_add_devices(platform_7109_tkdma,1);
