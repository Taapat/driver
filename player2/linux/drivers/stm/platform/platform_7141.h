...
static struct resource tkdma_resource_7141[] = {
        [0] = { .start = 0xFE248000,
                .end   = 0xFE24FFFF,
...
struct platform_device tkdma_device_7141 = {
        .name = "tkdma",
        .id = -1,
        .num_resources = ARRAY_SIZE(tkdma_resource_7141),
        .resource = tkdma_resource_7141,
