...
#define MAX_BUFFER_DIMENSIONS   3
#define MAX_BUFFER_COMPONENTS   3
...
typedef struct CodecTrickModeParameters_s
{
    ...
    Rational_t                  MaximumNormalDecodeRate;
    Rational_t                  MaximumSubstandardDecodeRate;
    ...
    bool                        AutoAdjustDecodeRates;                  // Values to allow automatic adjustment of possible decode rates
    unsigned int                PixelsAtNormalRate;
    Rational_t                  FrameRateAtNormalRate;
    Rational_t                  BaseNormalDecodeRate;
    Rational_t                  BaseSubstandardDecodeRate;
