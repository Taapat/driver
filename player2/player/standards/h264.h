/************************************************************************
COPYRIGHT (C) SGS-THOMSON Microelectronics 2004
...
#else
#define H264_FRAME_MEMORY_SIZE                          0x800000        /* 8 Mb */
#define H264_STREAM_PARAMETERS_COUNT			64
#define H264_FRAME_PARAMETERS_COUNT			64
#define H264_MACROBLOCK_STRUCTURE_MEMORY                0x580000        /* 10 Mb handles 20 frames at 1920x1088 and all lower level cases */
#endif
