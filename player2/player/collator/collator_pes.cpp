...
unsigned int    Flags;
	...
	COLLATOR_DEBUG("StoredPesHeader[4] %d (%d); StoredPesHeader[5] %d\n",
		       StoredPesHeader[4], StoredPesHeader[4] << 8, StoredPesHeader[5]);
	...
	Bits.SetPointer( StoredPesHeader + 9 );
...
report( severity_info, "Collator PTS 0 - %2d:%02d:%02d.%03d - %016llx - %c%lld - %c%lld\n", 
