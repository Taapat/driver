...
unsigned char		Policy;
    ...
    Playback->PresentationIntervalStartNormalizedTime	= Playback->RequestedPresentationIntervalStartNormalizedTime;
    Playback->PresentationIntervalEndNormalizedTime	= Playback->RequestedPresentationIntervalEndNormalizedTime;
	...
	if( Policy == PolicyValueApply )
	{
		...
		Playback->PresentationIntervalStartNormalizedTime	= NormalizedTimeAtStartOfDrain;
	    else
		Playback->PresentationIntervalEndNormalizedTime		= NormalizedTimeAtStartOfDrain;
	}
    }
...
//#endif
    ...
    if( NativeTime == INVALID_TIME ) {
		...
		report( severity_info, "Invalid, reset all time mappings\n" );
