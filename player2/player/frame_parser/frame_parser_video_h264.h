...
private:
    ...
    H264SliceHeader_t                             SliceHeaderRead;
    H264SliceHeader_t                            *SliceHeader;                          // Varied
    ...
    FrameParserStatus_t   ReadNalSupplementalEnhancementInformation( unsigned int	  MaximumSize );
