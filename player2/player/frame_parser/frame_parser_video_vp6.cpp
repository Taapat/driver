...
FrameParserStatus_t   FrameParser_VideoVp6_c::RevPlayGeneratePostDecodeParameterSettings (void)
{
    //
...
FrameParserStatus_t   FrameParser_VideoVp6_c::RevPlayRemoveReferenceFrameFromList (void)
{
    if (ReferenceFrameList.EntryCount != 0)
    {
