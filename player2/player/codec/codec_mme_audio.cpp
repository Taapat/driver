...
//
	...
	*((MME_LxPcmProcessingGlobalParams_Subset_t *) PcmParams_p);
    ...
    cmc.Config[CMC_OUTMODE_MAIN] = MODE_ID; // output raw decoded data on the main channels
    cmc.Config[CMC_OUTMODE_AUX] = MODE_ID; // no stereo downmix
...
//
    ...
    dmix.Config[DMIX_NORMALIZE] = ACC_MME_FALSE;
...
//
    ...
    Request->Dimension[2]       = ParsedAudioParameters->SampleCount?ParsedAudioParameters->SampleCount:2048;
