...
CodecStatus_t   Codec_MmeVideoVc1_c::FillOutDecodeCommand(       void )
{
    ...
    Decode->LumaDecimated_p                     = (VC9_LumaAddress_t)BufferState[CurrentDecodeBufferIndex].BufferLumaPointer;
    Decode->ChromaDecimated_p                   = (VC9_ChromaAddress_t)BufferState[CurrentDecodeBufferIndex].BufferChromaPointer;
