...
Definition of the stream specific codec implementation for lpcm audio in player 2


Date        Modification                                    Name
----        ------------                                    --------
10-Jul-07   Created (from codec_mme_audio_mpeg.h)           Adam
...
protected:
    ...
    LpcmAudioStreamParameters_t *StreamParams;
