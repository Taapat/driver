/***********************************************************************
 *
 * File: stgfb/Gamma/stb7100/stb7109dei.h
...
class CSTb7109DEI: public CGammaCompositorVideoPlane
{
friend class CSTi7200FlexVP;
public:
    CSTb7109DEI(stm_plane_id_t GDPid, CGammaVideoPlug *, ULONG deiBaseAddr);
    virtual ~CSTb7109DEI(void);
...
protected:
    ...
    const FMDSW_FmdInitParams_t *m_fmd_init_params;
