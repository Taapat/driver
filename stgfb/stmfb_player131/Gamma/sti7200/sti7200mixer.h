/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200mixer.h
...
class CSTi7200RemoteMixer: public CGammaMixer
{
public:
  CSTi7200RemoteMixer(CDisplayDevice* pDev);

private:
  CSTi7200RemoteMixer(const CSTi7200RemoteMixer&);
  CSTi7200RemoteMixer& operator=(const CSTi7200RemoteMixer&);
};
