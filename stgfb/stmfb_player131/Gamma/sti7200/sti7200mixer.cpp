/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200mixer.cpp
...
///////////////////////////////////////////////////////////////////////////////
//
// 7200 Remote display mixer

CSTi7200RemoteMixer::CSTi7200RemoteMixer(CDisplayDevice* pDev):
  CGammaMixer(pDev, STi7200_MIXER1_OFFSET+STi7200_REMOTE_COMPOSITOR_BASE)
{
  ...
  /*
   * Default plane order to BKG -> VID1 -> GDP1
   */
  ULONG ulCRBReg = (MIX_CRB_VID1 << MIX_CRB_DEPTH1_SHIFT) |
