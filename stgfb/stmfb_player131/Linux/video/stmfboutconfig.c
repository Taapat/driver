/***********************************************************************
 *
 * File: stgfb/Linux/video/stmfboutconfig.c
  ...
  switch(c->outputid)
  {
    case 1:
      ...
      *c = i->main_config;
      break;
    case 2:
      if(i->aux_config.outputid == c->outputid)
      {
        DPRINTK("returning aux configuration (address = %p)\n",&i->aux_config);
        *c = i->aux_config;
        break;
      }
      /*
                                    ...
                                    struct stmfbio_output_configuration *newconfig)
{
  ...
  if(((c->hdmi_config & STMFBIO_OUTPUT_HDMI_COLOURDEPTH_MASK) != 0) &&
...
{
  stm_display_output_t *o = 0;
  struct stmfbio_output_configuration *newconfig = 0;
  ...
  switch(c->outputid)
  {
    case 1:
      ...
      break;
    case 2:
      DPRINTK("Updating aux output configuration\n");

      o = i->pFBAuxOutput;
      newconfig = &i->aux_config;
      break;
    default:
