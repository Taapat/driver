/***********************************************************************
 *
 * File: stgfb/Gamma/stb7100/stb7100analogueouts.h
...
class CSTb7100MainOutput: public CGenericGammaOutput
{
public:
...
private:
  ...
  void WriteVOSReg(ULONG reg, ULONG val) { g_pIOS->WriteRegister(m_pGammaReg + ((STb7100_VOS_BASE + reg)>>2), val); }
  ULONG ReadVOSReg(ULONG reg) { return g_pIOS->ReadRegister(m_pGammaReg + ((STb7100_VOS_BASE +reg)>>2)); }

  void WriteSysCfgReg(ULONG reg, ULONG val) { g_pIOS->WriteRegister(m_pGammaReg + ((STb7100_SYSCFG_BASE + reg)>>2), val); }
  ULONG ReadSysCfgReg(ULONG reg) { return g_pIOS->ReadRegister(m_pGammaReg + ((STb7100_SYSCFG_BASE +reg)>>2)); }

  void WriteClkReg(ULONG reg, ULONG val) { g_pIOS->WriteRegister(m_pGammaReg + ((STb7100_CLKGEN_BASE + reg)>>2), val); }
  ULONG ReadClkReg(ULONG reg) { return g_pIOS->ReadRegister(m_pGammaReg + ((STb7100_CLKGEN_BASE +reg)>>2)); }
...
class CSTb7100AuxOutput: public CGenericGammaOutput
{
public:
