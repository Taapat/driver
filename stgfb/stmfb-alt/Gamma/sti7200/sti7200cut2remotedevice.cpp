/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200cut2remotedevice.cpp
...
bool CSTi7200Cut2RemoteDevice::Create()
{
  ...
  if(!m_graphicsAccelerators[STi7200c2_BLITTER_IDX_VDP2_MAIN])
  {
    DEBUGF(("CSTi7200Cut2RemoteDevice::Create - failed to get AQ\n"));
    return false;
  }
