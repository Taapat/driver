/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200cut2localdevice.cpp
...
bool CSTi7200Cut2LocalDevice::Create()
{
  ...
  m_pDENC = new CSTi7200Cut2LocalDENC(this, (STi7200C2_LOCAL_DISPLAY_BASE+STi7200_LOCAL_DENC_OFFSET), m_pTeletext);
  ...
  if(!m_graphicsAccelerators[STi7200c2_BLITTER_IDX_VDP0_MAIN]
