/***********************************************************************
 *
 * File: stgfb/Linux/media/video/stmvout_display.c
...
int stmvout_set_video_output(stvout_device_t *pDev, enum STM_VOUT_OUTPUT_ID id)
{
  ...
  switch(id)
  {
    case SVOI_MAIN:
      ...
      break;
    case SVOI_AUX:
      outputnr = pDev->displayPipe.aux_output_id;
      break;
    default:
      return -ENODEV;
  }
...
/******************************************************************************
 *  stmvout_get_supported_standards - ioctl helper for ENUMOUTPUT
 *
...
/******************************************************************************
 *  stmvout_set_current_standard - ioctl helper for S_OUTPUT_STD
 *
 *  returns 0 on success or a standard error code.
 */
...
/******************************************************************************
 *  stmvout_get_current_standard - ioctl helper for G_OUTPUT_STD
 *
 *  returns 0 on success or a standard error code.
 */
...
/******************************************************************************
 *  stmvout_get_display_standard - ioctl helper ENUM_OUTPUT_STD
 *
 *  returns 0 on success or a standard error code.
 */
...
/******************************************************************************
 *  stmvout_get_display_size - ioctl helper for CROPCAP
 *
 *  returns 0 on success or a standard error code.
 */
