/***********************************************************************
 *
 * File: stgfb/Linux/video/stmcorehdmi.h
...
#define STM_CEA_CAPS_PIXEL_DOUBLE_SD (1<<6)
#define STM_CEA_CAPS_PIXEL_QUAD_SD   (1<<7)
#define STM_CEA_CAPS_PIXEL_DOUBLE_ED (1<<8)
#define STM_CEA_CAPS_PIXEL_QUAD_ED   (1<<9)
