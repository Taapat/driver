/***********************************************************************
 *
 * File: stgfb/include/stmdisplayblitter.h
...
/* Note that this must always match the public declaration for enum
   stm_blitter_device in Linux/video/stmfb.h
...
/* Note that this must always match the public declaration for struct
   STMFBBdispSharedArea in Linux/video/stmfb.h
 ...
 * public linux defines for BLT_OP_FLAGS.
 */
...
#define STM_BLITTER_FLAGS_SRC_COLOURSPACE_709     0x00400000
#define STM_BLITTER_FLAGS_DST_COLOURSPACE_709     0x00800000
#define STM_BLITTER_FLAGS_SRC_COLOURSPACE_601     0x00000000
#define STM_BLITTER_FLAGS_DST_COLOURSPACE_601     0x00000000
