/***********************************************************************
 *
 * File: stgfb/Gamma/GammaCompositorGDP.h
...
class CGammaCompositorGDP: public CGammaCompositorPlane
{
  public:
    ...
    DMA_Area *GetGDPRegisters(void) { return &m_Registers; }
  ...
  protected:
    ...
    bool setOutputViewport(GENERIC_GDP_LLU_NODE          &topNode,
                           GENERIC_GDP_LLU_NODE          &botNode,
                           const GAMMA_QUEUE_BUFFER_INFO &qbinfo);
    ...
    void writeFieldSetup(GENERIC_GDP_LLU_NODE *fieldsetup);
