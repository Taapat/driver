/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200cut2localauxoutput.cpp
...
{
  DEBUGF2(2,("CSTi7200Cut2LocalAuxOutput::CSTi7200Cut2LocalAuxOutput - m_pVTG   = %p\n", m_pVTG));
  DEBUGF2(2,("CSTi7200Cut2LocalAuxOutput::CSTi7200Cut2LocalAuxOutput - m_pDENC  = %p\n", m_pDENC));
  DEBUGF2(2,("CSTi7200Cut2LocalAuxOutput::CSTi7200Cut2LocalAuxOutput - m_pMixer = %p\n", m_pMixer));

  m_pAWG = pAWG;
  m_pHDFOutput = pHDFOutput;

  m_ulInputSource = STM_AV_SOURCE_MAIN_INPUT;
  CSTi7200Cut2LocalAuxOutput::SetControl(STM_CTRL_VIDEO_OUT_SELECT,(STM_VIDEO_OUT_YC | STM_VIDEO_OUT_CVBS));
...
const stm_mode_line_t* CSTi7200Cut2LocalAuxOutput::SupportedMode(const stm_mode_line_t *mode) const
{
...
ULONG CSTi7200Cut2LocalAuxOutput::GetCapabilities(void) const
{
...
bool CSTi7200Cut2LocalAuxOutput::SetOutputFormat(ULONG format)
{
  DEBUGF2(2,("CSTi7200Cut2LocalAuxOutput::SetOutputFormat - format = 0x%lx\n",format));
  ...
  if(m_pCurrentMode)
  {
    ...
    if(format & (STM_VIDEO_OUT_RGB | STM_VIDEO_OUT_YUV))
    {
       ...
       */
      val = ReadAuxTVOutReg(TVOUT_GP_OUT) | TVOUT_GP_OUT_HD_PIX_SD_N_HD;
