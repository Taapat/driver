/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200remoteoutput.cpp
...
////////////////////////////////////////////////////////////////////////////////
//
CSTi7200Cut1RemoteOutput::CSTi7200Cut1RemoteOutput(
    CSTi7200Cut1RemoteDevice *pDev,
    CSTmSDVTG                *pVTG,
    CSTi7200DENC             *pDENC,
    CSTi7200RemoteMixer      *pMixer,
    CSTmFSynthType2          *pFSynth): CSTi7200RemoteOutput(pDev, STi7200C1_REMOTE_TVOUT_BASE, pVTG, pDENC, pMixer, pFSynth)
{
  DENTRY();
  /*
   * System glue setup for clocks
   */
  ULONG tmp = ReadLocalAuxTVOutReg(TVOUT_PADS_CTL) & ~(TVOUT_CLK_MASK << TVOUT_AUX_PADS_REMOTE_DIV_SHIFT);
  tmp |= (TVOUT_CLK_DIV_2 << TVOUT_AUX_PADS_REMOTE_DIV_SHIFT);
  WriteLocalAuxTVOutReg(TVOUT_PADS_CTL, tmp);

  tmp = ReadHDMIReg(STM_HDMI_SYNC_CFG) & ~(HDMI_GPOUT_REMOTE_PIX_HD |
                                           HDMI_GPOUT_REMOTE_SDTVO_HD);
  WriteHDMIReg(STM_HDMI_SYNC_CFG, tmp);

  tmp = ReadClkReg(CLKB_OUT_MUX_CFG) & ~CLKBC1_OUT_MUX_SD1_EXT;
...
CSTi7200Cut1RemoteOutput::~CSTi7200Cut1RemoteOutput(void) {}
