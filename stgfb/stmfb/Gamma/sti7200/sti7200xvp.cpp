/***********************************************************************
 *
 * File: stgfb/Gamma/sti7200/sti7200xvp.cpp
...
#include <Gamma/sti7200/sti7200flexvp.h>
...
//                                   SDAAF_VIDEO_MEMORY);
          ...
          DEBUGF (("%s: pMemory/ulPhysical TNR mem @ %p/%.8x\n",
                   __PRETTY_FUNCTION__,
                           ...
                           const struct XVP_QUEUE_BUFFER_INFO * const qbi) const
{
  ...
  switch (setup->eMode)
    ...
    case PCxVPC_TNR_NLEOVER:
      ...
      setup->topField.lumaZoom    = (qbi->tVHSRC_LUMA_VSRC << 16) | qbi->VHSRC_LUMA_HSRC;
      setup->botField.lumaZoom    = (qbi->bVHSRC_LUMA_VSRC << 16) | qbi->VHSRC_LUMA_HSRC;
      setup->altTopField.lumaZoom = (qbi->atVHSRC_LUMA_VSRC << 16) | qbi->VHSRC_LUMA_HSRC;
      setup->altBotField.lumaZoom = (qbi->abVHSRC_LUMA_VSRC << 16) | qbi->VHSRC_LUMA_HSRC;
