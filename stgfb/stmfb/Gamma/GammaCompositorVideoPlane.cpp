...
bool CGammaCompositorVideoPlane::Create(void)
{
    ...
    DEBUGF2(2,("CGammaCompositorVideoPlane::Create &m_HFilter = %p pMemory = %p pData = %p phys = %08x\n",&m_HFilter,m_HFilter.pMemory,m_HFilter.pData,m_HFilter.ulPhysical));
    ...
    DEBUGF2(2,("CGammaCompositorVideoPlane::Create &m_VFilter = %p pMemory = %p pData = %p phys = %08x\n",&m_VFilter,m_VFilter.pMemory,m_VFilter.pData,m_VFilter.ulPhysical));
    return true;
}
