...
mkdir -p board_tests/mb519
make ARCH=sh CONFIG_STI7200_MB519=y clean
make ARCH=sh CONFIG_STI7200_MB519=y 
sh4strip -o board_tests/mb519/interlaced_display.out tests/interlaced_display/interlaced_display.out
sh4strip -o board_tests/mb519/progressive_display.out tests/progressive_display/progressive_display.out
cp $FIRMWARE_HOME/component_7200c1_mb519.fw board_tests/mb519/component.fw
...
cp $FIRMWARE_HOME/component_7111_mb618.fw board_tests/mb628/component.fw
...
cp $FIRMWARE_HOME/component_7200c2_mb671.fw board_tests/mb671/component.fw
