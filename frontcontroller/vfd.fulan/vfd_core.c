/*$Source: D:/STB_BASE_HAL/stb_hal_st7111_linux/environment/bin/runtime_usb/vfd.fulan/vfd_core.c,v $*/
/*****************************文件头部注释*************************************/
//
...
{
	ywtrace_print(TRACE_INFO, "vfd module initialized... \n");
	//YWPANEL_VFD_Init();
	return 0;
}
