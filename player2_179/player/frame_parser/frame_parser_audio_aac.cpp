...
FrameParserStatus_t Status;
    ...
    // Vincent added this to work around bug #5902
    if ( !ValidTime( NextFrameNormalizedPlaybackTime ) && ValidTime( CodedFrameParameters->PlaybackTime ) ) {
        TranslatePlaybackTimeNativeToNormalized( CodedFrameParameters->PlaybackTime, 
						 &NextFrameNormalizedPlaybackTime );
	FRAME_ERROR("Providing a fake NextFrameNormalizedPlaybackTime as fallback %llx\n", NextFrameNormalizedPlaybackTime);
    }
