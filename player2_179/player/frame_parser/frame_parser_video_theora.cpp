...
FrameParserStatus_t   FrameParser_VideoTheora_c::RevPlayGeneratePostDecodeParameterSettings (void)
{
    //
...
FrameParserStatus_t   FrameParser_VideoTheora_c::RevPlayRemoveReferenceFrameFromList (void)
{
    if (ReferenceFrameList.EntryCount != 0)
    {
