...
#ifdef __TDT__
                    //player crash if icoming source width/height not standard (Kernel panic - not syncing: Need true 64-bit/64-bit division)
                    if( (VideoParameters->Width == 720 && VideoParameters->Height == 576) || (VideoParameters->Width == 1280 && VideoParameters->Height == 720) || (VideoParameters->Width == 1920 && (VideoParameters->Height == 1080 || VideoParameters->Height == 1088)) )
                    {
