...
CodecStatus_t   Codec_MmeVideoVc1_c::CheckCodecReturnParameters( CodecBaseDecodeContext_t *Context )
{
  ...
  if ( AdditionalInfo_p != NULL) {
	...
	{
	  //report( severity_info,  "Codec_MmeVideoVc1_c::CheckCodecReturnParameters - VC9_DECODER_ERROR_MB_OVERFLOW   %x \n" , AdditionalInfo_p->ErrorCode );
	  break;
	}
        case VC9_DECODER_ERROR_RECOVERED:
	{
	  report( severity_info,  "Codec_MmeVideoVc1_c::CheckCodecReturnParameters - VC9_DECODER_ERROR_RECOVERED     %x \n" , AdditionalInfo_p->ErrorCode );
	  break;
	}
        case VC9_DECODER_ERROR_NOT_RECOVERED:
	{
	  report( severity_info,  "Codec_MmeVideoVc1_c::CheckCodecReturnParameters - VC9_DECODER_ERROR_NOT_RECOVERED %x \n" , AdditionalInfo_p->ErrorCode );
	  break;
	}
        case VC9_DECODER_ERROR_TASK_TIMEOUT:
	{
	  report( severity_info,  "Codec_MmeVideoVc1_c::CheckCodecReturnParameters - VC9_DECODER_ERROR_TASK_TIMEOUT  %x \n" , AdditionalInfo_p->ErrorCode );
	  break;
	}
      }
    }
