...
//
    ...
    StreamSetOption( Context->DeviceContext->VideoStream, PLAY_OPTION_EXTERNAL_TIME_MAPPING_VSYNC_LOCKED, 
...
int			 Result;
    ...
    StreamRegisterEventSignalCallback( 	Context->DeviceContext->VideoStream, (context_handle_t)Context, 
    ...
    StreamSetOption( Context->DeviceContext->VideoStream, PLAY_OPTION_DECIMATE_DECODER_OUTPUT,  PLAY_OPTION_VALUE_DECIMATE_DECODER_OUTPUT_DISABLED );
    StreamSetOption( Context->DeviceContext->VideoStream, PLAY_OPTION_DISPLAY_FIRST_FRAME_EARLY,PLAY_OPTION_VALUE_DISABLE );
    ...
    StreamRegisterEventSignalCallback( Context->DeviceContext->VideoStream, NULL, NULL );
...
#if 0
#if 1
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_16_BIT,					0 );
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_BIG_ENDIAN,	 			0 );

//		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_HORIZONTAL_OFFSET,	-1 );
//		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_VERTICAL_OFFSET,	-1 );
//		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_BIG_ENDIAN,	 			0 );
//		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_INCOMPLETE_FIRST_PIXEL, 			0 );
#else
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_HORIZONTAL_OFFSET,	-119 );
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_VERTICAL_OFFSET,	-36 );
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_EXTERNAL_SYNC,				0 );
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_BIG_ENDIAN,	 			0 );
		DvpVideoIoctlSetControl( Context, V4L2_CID_STM_DVPIF_INCOMPLETE_FIRST_PIXEL, 			0 );
#endif
#endif
...
Context->DvpControlOutputCropTransitionModeParameter0		= 60;
	...
	case V4L2_CID_STM_DVPIF_PIXEL_ASPECT_RATIO_CORRECTION:
	        ...
	        StreamSetOption( Context->DeviceContext->VideoStream, PLAY_OPTION_PIXEL_ASPECT_RATIO_CORRECTION, 
