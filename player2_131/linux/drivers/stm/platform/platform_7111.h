...
static struct resource tkdma_resource_7111[] = {
        [0] = { .start = 0xFE248000,
                .end   = 0xFE24FFFF,
                .flags = IORESOURCE_MEM,     },
        [1] = { .start = evt2irq(0x16a0),
                .end   = evt2irq(0x16a0),
                .flags = IORESOURCE_IRQ, },
};

struct platform_device tkdma_device_7111 = {
        .name = "tkdma",
        .id = -1,
        .num_resources = ARRAY_SIZE(tkdma_resource_7111),
        .resource = tkdma_resource_7111,
