...
static struct resource tkdma_resource_7105[] = {
        [0] = { .start = 0xFE248000,
                .end   = 0xFE24FFFF,
...
struct platform_device tkdma_device_7105 = {
        .name = "tkdma",
        .id = -1,
        .num_resources = ARRAY_SIZE(tkdma_resource_7105),
        .resource = tkdma_resource_7105,
