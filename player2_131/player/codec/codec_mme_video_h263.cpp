...
Codec_MmeVideoH263_c::Codec_MmeVideoH263_c( void )
{
    ...
    Configuration.CodedMemorySize                       = 0x400000;
    Configuration.MaximumCodedFrameSize                 = 0x80000;
...
CodecStatus_t   Codec_MmeVideoH263_c::HandleCapabilities( void )
{
    ...
    report (severity_info, "    caps len e                        = %d bytes\n", H263TransformerCapability.caps_len);
    //report (severity_info, "    Version                           = %d\n", H263TransformerCapability.Version);
    //report (severity_info, "    Input type                        = %d\n", H263Transformerapability.InputType);
    //report (severity_info, "    Output type                       = %d\n", H263TransformerCapability.OutputType);
    //report (severity_info, "    Output type                       = %d\n", H263TransformerCapability.OutputType);
