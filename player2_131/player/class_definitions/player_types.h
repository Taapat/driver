...
#if 0
#define ByFreeRun                               2
#define ManifestSampleRateConvert               4
#define ManifestPitchCorrected                  5
#endif

typedef enum
{
    //
    // These are here as placeholders, none of them are implemented at this time
    //
...
#define PolicyValueDiscardLateFramesAfterSynchronize                    2
    ...
    //
    // Policy determining whether or not we downgrade the
    // codec capabilities when it fails to decode frames at
    // an appropriate rate.
    //

    PolicyLowerCodecDecodeLimitsOnFailureToDecodeInTime,
...
//
    // Policy enabling a workaround for badly coded dpb values
    //
