...
#define JPEG_ERROR_ID   0
#define JPEG_ERROR_BASE (JPEG_ERROR_ID << 16)
...
typedef struct
	{
	JPEGD_InitParams_t outputSettings;						 /* Steering of size/widht/height of output picture */
	} JPEGD_TransformParams_t;
...
typedef struct
    ...
    JPEGD_ErrorCodes_t  ErrorType; 
	} JPEGD_TransformReturnParams_t;
