/***********************************************************************
 *
 * File: stgfb/include/stmdisplayplane.h
...
typedef enum
{
  ...
  PLANE_CTRL_IQI_CONTRAST,      /* IQI contrast << 16 | blacklevel */
  PLANE_CTRL_IQI_SATURATION,    /* IQI saturation  */
  PLANE_CTRL_IQI_LAST = PLANE_CTRL_IQI_SATURATION,
  ...
  PLANE_CTRL_DEI_LAST = PLANE_CTRL_DEI_MODE,
...
#define STM_PLANE_SRC_XY_IN_32NDS         (1L<<12) /* x,y crop coordinates are specified in 16ths of pixel/line */
...
{
  TIME64 vsyncTime;
  ULONG  ulStatus;               /* Plane status flags at this timestamp */
